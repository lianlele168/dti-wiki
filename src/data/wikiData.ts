...
export const ACTIVE_CODES: CodeItem[] = [
  { code: 'LANADOLLDRESS', reward: 'Lana Tutu Dress', itemType: 'Clothing', status: 'Active', addedDate: '' },
  { code: 'PROUD', reward: 'Pride 2026 Rainbow Dress', itemType: 'Clothing', status: 'Active', addedDate: '' },
  { code: 'CA11MEHHALEY', reward: 'Bear Ears, Dress, and Onesie', itemType: 'Clothing', status: 'Active', addedDate: '' },
  { code: 'CH00P1E_B4CK_AGA1N', reward: 'Choopie Outfit Set Rework', itemType: 'Clothing', status: 'Active', addedDate: '' },
  { code: 'VANILLAMACE', reward: 'Head Accessory / Headscarf', itemType: 'Accessory', status: 'Active', addedDate: '' },
  { code: 'PIXIIUWU', reward: 'Flowing Long Dress', itemType: 'Clothing', status: 'Active', addedDate: '' },
  { code: 'ANGELT4NKED', reward: 'Special Helmet', itemType: 'Accessory', status: 'Active', addedDate: '' },
  { code: '3NCHANTEDD1ZZY', reward: 'Magical Wand', itemType: 'Accessory', status: 'Active', addedDate: '' },
  { code: '1CON1CF4TMA', reward: 'Sweater / Sweater Dress', itemType: 'Clothing', status: 'Active', addedDate: '' },
  { code: 'MEGANPLAYSBOOTS', reward: 'MeganPlays Boots', itemType: 'Accessory', status: 'Active', addedDate: '' },
  { code: 'LANA', reward: 'White Shorts, Shirt, and Legwarmers', itemType: 'Clothing', status: 'Active', addedDate: '' },
  { code: 'LANABOW', reward: 'White Bow Accessory', itemType: 'Accessory', status: 'Active', addedDate: '' },
  { code: 'BELALASLAY', reward: 'Black Jacket with Pink Halter Top', itemType: 'Clothing', status: 'Active', addedDate: '' },
  { code: 'UMOYAE', reward: 'Blue Minidress', itemType: 'Clothing', status: 'Active', addedDate: '' },
  { code: 'D1ORST4R', reward: 'Designer Bag and Bow', itemType: 'Accessory', status: 'Active', addedDate: '' },
  { code: 'ELLA', reward: 'Pink Skirt', itemType: 'Clothing', status: 'Active', addedDate: '' },
  { code: 'ASHLEYBUNNI', reward: 'Bunny Slippers', itemType: 'Accessory', status: 'Active', addedDate: '' },
  { code: 'LEAHASHE', reward: 'Sweatshirt and Sweatpants Set', itemType: 'Clothing', status: 'Active', addedDate: '' },
  { code: 'KREEK', reward: 'KreekCraft Bear Hat', itemType: 'Accessory', status: 'Active', addedDate: '' },
  { code: 'KITTYUUHH', reward: 'Black Pet Cat', itemType: 'Accessory', status: 'Active', addedDate: '' },
  { code: 'LABOOTS', reward: 'Black Cyber Boots', itemType: 'Accessory', status: 'Active', addedDate: '' },
  { code: 'TEKKYOOZ', reward: 'Pearl Handbag', itemType: 'Accessory', status: 'Active', addedDate: '' },
  { code: 'M3RM4ID', reward: 'Orange Mermaid Set', itemType: 'Clothing', status: 'Active', addedDate: '' },
];
